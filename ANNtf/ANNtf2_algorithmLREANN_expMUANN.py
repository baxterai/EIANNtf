...
Define fully connected learning rule experiment artificial neural network - multi propagation (per layer; with synaptic delta calculation) update (LREANN_expMUANN)
